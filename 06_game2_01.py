...
def main():
  ...
  char_arr.append(PlayerCharacter('marisa', (12, 4), './data/img/reimu.png'))
  char_arr.append(PlayerCharacter('marisa2', (16, 4), './data/img/reimu.png'))
  for _ in char_arr:
    cmd_move.append(-1)
    cmd_move_km.append([])
  ...
  cmd_move_km[2] = [pg.K_i, pg.K_l, pg.K_k, pg.K_j]
